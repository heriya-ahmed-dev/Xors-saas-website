...
const FeatureBar = () => {
  return (
    ...
    <div className='d-none d-md-flex justify-content-around mb-4 feature_box w-[1100px] h-[250px] pt-5'>
        ...
        <div>
            <img src={detail2} className='w-[60px] h-[60px] rounded-circle detail'/>
            <p className='fs-5 fw-bold  pt-3'>Collaborate <br/> with your team</p>
        </div>


        <div>
            <img src={detail3} className='w-[60px] h-[60px] rounded-circle detail'/>
            <p className='fs-5 fw-bold  pt-3'>Ultra fast <br/> cloud-engine</p>
        </div>

    
         <div>
            <img src={detail4} className='w-[60px] h-[60px] rounded-circle detail'/>
